 ...
 */
static int 
summary_get_SummaryInformation(ole2_t ole2, void * user_data,
 ...
 */
static int 
summary_get_DocumentSummaryInformation(ole2_t ole2, void * user_data,
	int (*callback)(void * user_data, uint32_t propid, uint32_t dwType, uint32_t * value));
...
int _summary_get(int doc_summary, ole2_t ole2, void * user_data,
	int (*callback)(void * user_data, uint32_t propid, uint32_t dwType, uint32_t * value))
{
	...
	ole2_dir_t dir = ole2_get_dir(ole2, dirname);
	if (!dir)
...
int summary_get_SummaryInformation(ole2_t ole2, void * user_data,
	int (*callback)(void * user_data, uint32_t propid, uint32_t dwType, uint32_t * value))
{
	return _summary_get(0, ole2, user_data, callback);
}

int summary_get_DocumentSummaryInformation(ole2_t ole2, void * user_data,
	int (*callback)(void * user_data, uint32_t propid, uint32_t dwType, uint32_t * value))
{
	return _summary_get(1, ole2, user_data, callback);
}
